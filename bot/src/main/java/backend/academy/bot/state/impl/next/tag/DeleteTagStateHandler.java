...
@Slf4j
@Component
public class DeleteTagStateHandler extends AbstractStateHandlerWithNext {
    ...
    public void handle(long chatId, String text) {
        log.info("Handling DELETE_TAG state for chatId={}", chatId);

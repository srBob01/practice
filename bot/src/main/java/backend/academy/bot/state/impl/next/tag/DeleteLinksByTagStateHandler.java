...
@Slf4j
@Component
public class DeleteLinksByTagStateHandler extends AbstractStateHandlerWithNext {

    private static final String ENTER_TAG_MESSAGE =
            "Please enter the tag to delete all related links. To exit input, enter /end";

    public DeleteLinksByTagStateHandler(
    ...
    public void handle(long chatId, String text) {
        log.info("Handling DELETE_LINKS_BY_TAG state for chatId={}", chatId);
    ...
    public State getProcessedState() {
        return State.DELETE_LINKS_BY_TAG;
    }
}
